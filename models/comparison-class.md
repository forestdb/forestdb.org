...
### Listener 1 model (unambiguous alternatives)

+ Same as above but with alternatives:
  - Adjective phrases with explicit comparison classes (e.g., "John is tall for a basketball player")
  - Maximal set is 7 alternatives: No explicit comparison class, subordinate class, superordinate class for each of positive (e.g., tall) and negative (e.g., short) adjectives + silence
...
display("positive (sub) --> for a super? = " + exp(pragmaticListener("positive").score("super")))
display("negative (sub) --> for a super? =  " + exp(pragmaticListener("negative").score("super")))
