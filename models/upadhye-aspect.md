---
layout: model
title: Episodic and Habitual Event Interpretation
...
Considering these limitations, an important next step would be the empirical estimation of the *alpha*, *beta*, *gamma*, and *phi* parameters used to characterize the state distribution. Additionally, a modification that I am currently working on (based on a suggestion during presentation) is implementing a threshold semantics for habituals in the meaning function.
